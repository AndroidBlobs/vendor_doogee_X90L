...
BOOT_LOGO = e936_dg_x90l_39_p0_hd600
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
FINGERPRINT_SUNWAVE_REE = no
FINGERPRINT_MICROARRAY_TRUSTKERNEL_TEE = yes
FINGERPRINT_SUNWAVE_TRUSTKERNEL_TEE = yes

#End For Driver------------------------------------------------------------}


#camera-----------------------
CUSTOM_HAL_IMGSENSOR = gc2365_mipi_raw gc23650_mipi_raw gc0310_mipi_yuv imx135_mipi_raw gc8024_mipi_raw gc8034_mipi_raw gc5025_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = gc2365_mipi_raw imx135_mipi_raw gc8034_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = gc23650_mipi_raw gc8024_mipi_raw gc5025_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR = gc0310_mipi_yuv

CUSTOM_KERNEL_IMGSENSOR = gc2365_mipi_raw gc23650_mipi_raw gc0310_mipi_yuv imx135_mipi_raw gc8024_mipi_raw gc8034_mipi_raw gc5025_mipi_raw
CUSTOM_KERNEL_MAIN_IMGSENSOR = gc2365_mipi_raw imx135_mipi_raw gc8034_mipi_raw
CUSTOM_KERNEL_SUB_IMGSENSOR = gc23650_mipi_raw gc8024_mipi_raw gc5025_mipi_raw
...
WTK_BUILD_VERNO = DOOGEE-X90L-Android9.0-20190322
WTK_INTERNAL_BUILD_VERNO = E936_DG_X90L_39_P0_V1.2.1.2_S190419

#End For Common----------------------------------------------------------}

CUSTOM_DG_RINGTONES = yes
#add by wuzhi.peng for AQJJ-80 start
WTK_PTP_LABEL = X90L
WTK_MTP_LABEL = X90L
WTK_STRESS_TEST = yes
#add by wuzhi.peng for AQJJ-80 end

#add TQWB-900 xudong.zhang 20171228(start)
WTK_HIDE_ETWS_ICON = yes
#add TQWB-900 xudong.zhang 20171228(end)
...
#adupsfota end
#add BUG_ID:EJSL-98 liuzhijun 20181205 (start)
WTK_TARGET_BOARD_NAME = E936
#add BUG_ID:EJSL-98 liuzhijun 20181205 (end)
#add by wuzhi.peng for qrscanner start
WTK_QRCODE_SUPPORT = yes
#add by wuzhi.peng for qrscanner end

#FACE_UNLOCK_SUPPORT start
FACE_UNLOCK_SUPPORT = true
ENTS_DGXNZO_TRUSTKERNEL_TEE = yes

#add by wushanfei for default home_page start
CHROME_CUSTOMIZATIONS_PACKAGES = yes
#add by wushanfei for default home_page end
#add BUG_ID:YJSQ-116 liuzhijun 20181203 (start)
WTK_NEW_PSM_SUPPORT = yes
#add BUG_ID:YJSQ-116 liuzhijun 20181203 (end)
#add by wuzhi.peng for YJSQ-119 start
WTK_SECURITY_LOCKER = yes
WTK_SECURITY_LOCKER_NOICON = yes
#add by wuzhi.peng for YJSQ-119 end

# A: Bug_id:add gangyun bokeh. chenchunyong 20181207 {
GANGYUN_BOKEH_SUPPORT = yes
# A: }

#debuid:YJSQ-1134 add by wangjian 20181214 start
REMOVE_BAIDULOCATION = yes
#debuid:YJSQ-1134 add by wangjian 20181214 end

WTK_BASEBAND_VERSION = DOOGEE-X90L.20190210
WTK_KERNEL_VERSION = DOOGEEinfo@doogee.cc20190210
#add by gang.liu for camera_cts 20180521 start
WTK_CAMERA_COVERED_SWITCH =yes
WTK_MAIN2_CTS_SUPPORT = yes
#add by gang.liu for camera_cts 20180521 end

#add by chenxuanyu start
WTK_DEFAULT_MTP = true
#add by chenxuanyu end

WTK_MOCK_FINGERPRINT = DOOGEE/X90L/X90L:9/P00610/1553768670:user/release-keys
WTK_MOCK_DESC = X90L-user 9 P00610 1553768670 release-keys
WTK_BUILD_INCREMENTAL = 1553768670
